...
use scsp_plugin_api::hook::{HookSite, HookTarget};
use scsp_core::TargetId;
...
scsp_plugin_api::define_hook_site!(SITE: HookSite<FakeTarget, Container>);

fn take(ctx: &mut scsp_plugin_api::AppCtx<'_>) {
