...
use scsp_core::{
    DataRoot, HookError, MethodRef, MethodResolver, RuntimeGate, SlotMemory, TargetId,
};
...
#[derive(Resource)]
struct WindowHandle(scsp_plugin_api::hook::InstalledHook<MockTargetMarker, MockSites>);
